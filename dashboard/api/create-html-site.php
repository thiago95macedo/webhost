...
try {
    ...
    // Execute html-multi.sh script
    $scriptPath = '/opt/webhost/scripts/html-multi.sh';
    ...
    $siteInfo = getHtmlSiteInfo($siteName);
    
    echo json_encode([
        'success' => true,
        'message' => 'Site HTML criado com sucesso',
        'site' => $siteInfo,
...
function getHtmlSiteInfo($siteName) {
    $webRoot = '/opt/webhost/sites/html';
